...
public class Constant {
    ...
    public static String APP_URL = "https://play.google.com/store/apps/details?id=com.breakevenpoint.tracker";
    private static String DESIGNED_BY = "Designed by Eajy in China";
    public static String SHARE_CONTENT = "A beautiful app designed By Neeraj:\n" + APP_URL + "\n- " + DESIGNED_BY;
    ...
    public static String MATERIAL_DESIGN_COLOR_PACKAGE = "com.breakevenpoint.tracker";
