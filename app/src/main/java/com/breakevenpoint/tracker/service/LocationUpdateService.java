package com.breakevenpoint.tracker.service;
...
public class LocationUpdateService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "com.breakevenpoint.tracker.service";
    /**
     ...
     */
    private static final long UPDATE_INTERVAL_IN_MILLISECONDS = 1000 * 60 *25;

    /**
     * The fastest rate for active location updates. Updates will never be more frequent
     * than this value.
     */
    private static final long FASTEST_UPDATE_INTERVAL_IN_MILLISECONDS =1000 * 60 *20;
...
//            handler.removeCallbacks(timedTask);
    ...
    private Notification getNotification() {
        ...
        PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, MapHomeActivity.class), 0);
    ...
    private void onNewLocation(Location location) {
        ...
        mLocation = location;
        //createSMSObject(mLocation);
        // on new location send rest Request
